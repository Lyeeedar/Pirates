...
// }
	...
	public void registerUniformBlock(String name, int bindPoint) {

		int index = Gdx.gl30.glGetUniformBlockIndex(program, name);
		if (index == GL30.GL_INVALID_INDEX)
			throw new RuntimeException("Uniform block \""+name+"\" not found. Make sure it is in use in the program. ");

		Gdx.gl30.glUniformBlockBinding(program, index, bindPoint);
	}
