 ...
 * </table>
 * </p> */
public class DiscardCameraGroupStrategy implements GroupStrategy, Disposable {
	...
	public DiscardCameraGroupStrategy (final Camera camera) {
	...
	public DiscardCameraGroupStrategy(Camera camera, Comparator<Decal> sorter) {
		this.camera = camera;
